...
#include "WaterBodyRiver_Buoyancy.generated.h"

UCLASS(Blueprintable)
class FRIENDSJOURNEY_API AWaterBodyRiver_Buoyancy : public AWaterBodyRiver, public IBuoyancyEventInterface
{
	GENERATED_BODY()

public:
	AWaterBodyRiver_Buoyancy();

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Audio")
	TObjectPtr<UAudioComponent> AudioComponent;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Audio")
	float AttenuationExtentsOffset = 100.0f;
