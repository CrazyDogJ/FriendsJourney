...
#include "CharacterDescriptionThumbnailRenderer.generated.h"

UCLASS()
class FRIENDSJOURNEYEDITOR_API UCharacterDescriptionThumbnailRenderer : public UTextureThumbnailRenderer
{
	GENERATED_BODY()
